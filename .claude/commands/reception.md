---
description: Gather third-party Reception signal for entries and draft each ## Reception section, tracked in .claude/reception-review.md
---
...
- In `.claude/reception-review.md`, change `- [ ]` to `- [x]` for **exactly** the entries you drafted this run.
