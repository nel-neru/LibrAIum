---
name: "source-command-format-sync"
description: "Mirror a data-format change across the Rust and Node implementations, prove conformance, and add a fixture"
---

# source-command-format-sync

Use this skill when the user asks to run the migrated source command `format-sync`.
...
- Update the Data Model section of `AGENTS.md`/`README.md` if the on-disk format visibly changed.
